...
//! resolves symbols, and renders the live UI lives outside staxd.
//!
...
//!
//! The matching daemon binary lives in `staxd`. The matching
//! consumer for the client lives in `stax-live` (and eventually a
//! standalone CLI mode).
...
pub struct DaemonStatus {
    /// staxd version string. Not used for compatibility — vox handles
