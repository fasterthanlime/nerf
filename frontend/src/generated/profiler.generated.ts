...
export interface ProbeDiffThread {
  ...
  kperf_kernel_stack_samples: bigint;
  ...
  pc_match: bigint;
  stitchable: bigint;
  richer_than_kperf: bigint;
  dwarf_richer_than_fp: bigint;
  compact_stitchable: bigint;
  compact_dwarf_stitchable: bigint;
  dwarf_stitchable: bigint;
  avg_common_suffix: number;
  avg_compact_common_suffix: number;
  avg_compact_dwarf_common_suffix: number;
  avg_dwarf_common_suffix: number;
...
export interface ProbeDiffEntry {
  ...
  compact_stack: ResolvedFrame[];
  compact_dwarf_stack: ResolvedFrame[];
  dwarf_stack: ResolvedFrame[];
  stitched_stack: ResolvedFrame[];
  common_suffix: number;
  compact_common_suffix: number;
  compact_dwarf_common_suffix: number;
  dwarf_common_suffix: number;
  pc_match: boolean;
  stitchable: boolean;
...
export interface ProbeDiffUpdate {
  ...
  total_probes: bigint;
  kperf_kernel_stack_samples: bigint;
  kperf_kernel_frames: bigint;
  max_kperf_kernel_frames: number;
  paired: bigint;
  paired_kernel_stack_samples: bigint;
  kperf_only: bigint;
  probe_only: bigint;
  probe_augmented_kperf: bigint;
  probe_walked_deeper: bigint;
  common_suffix_hist: bigint[];
  compact_suffix_hist: bigint[];
  compact_dwarf_suffix_hist: bigint[];
  dwarf_suffix_hist: bigint[];
  ...
  compact_used: bigint;
  compact_dwarf_used: bigint;
  fp_walk_used: bigint;
  threads: ProbeDiffThread[];
  richer: ProbeDiffEntry[];
  dwarf_richer: ProbeDiffEntry[];
...
export const profiler_send_schemas: import("@bearcove/vox-core").ServiceSendSchemas = {
  schemas: new Map<bigint, import("@bearcove/vox-postcard").Schema>([
    ...
    [0x1c34189e29fa175dn, { id: 0x1c34189e29fa175dn, type_params: [], kind: { tag: 'enum', name: 'TokenClass', variants: [{ name: 'Plain', index: 0, payload: { tag: 'unit' } }, { name: 'Keyword', index: 1, payload: { tag: 'unit' } }, { name: 'Function', index: 2, payload: { tag: 'unit' } }, { name: 'String', index: 3, payload: { tag: 'unit' } }, { name: 'Comment', index: 4, payload: { tag: 'unit' } }, { name: 'Type', index: 5, payload: { tag: 'unit' } }, { name: 'Variable', index: 6, payload: { tag: 'unit' } }, { name: 'Constant', index: 7, payload: { tag: 'unit' } }, { name: 'Number', index: 8, payload: { tag: 'unit' } }, { name: 'Operator', index: 9, payload: { tag: 'unit' } }, { name: 'Punctuation', index: 10, payload: { tag: 'unit' } }, { name: 'Property', index: 11, payload: { tag: 'unit' } }, { name: 'Attribute', index: 12, payload: { tag: 'unit' } }, { name: 'Tag', index: 13, payload: { tag: 'unit' } }, { name: 'Macro', index: 14, payload: { tag: 'unit' } }, { name: 'Label', index: 15, payload: { tag: 'unit' } }, { name: 'Namespace', index: 16, payload: { tag: 'unit' } }, { name: 'Constructor', index: 17, payload: { tag: 'unit' } }, { name: 'Title', index: 18, payload: { tag: 'unit' } }, { name: 'Strong', index: 19, payload: { tag: 'unit' } }, { name: 'Emphasis', index: 20, payload: { tag: 'unit' } }, { name: 'Link', index: 21, payload: { tag: 'unit' } }, { name: 'Literal', index: 22, payload: { tag: 'unit' } }, { name: 'Strikethrough', index: 23, payload: { tag: 'unit' } }, { name: 'DiffAdd', index: 24, payload: { tag: 'unit' } }, { name: 'DiffDelete', index: 25, payload: { tag: 'unit' } }, { name: 'Embedded', index: 26, payload: { tag: 'unit' } }, { name: 'Error', index: 27, payload: { tag: 'unit' } }] } }],
    [0x95417231062e40c8n, { id: 0x95417231062e40c8n, type_params: [], kind: { tag: 'struct', name: 'Token', fields: [{ name: 'text', type_ref: { tag: 'concrete', type_id: 0x6d7dce914ee150e8n, args: [] }, required: true }, { name: 'kind', type_ref: { tag: 'concrete', type_id: 0x1c34189e29fa175dn, args: [] }, required: true }] } }],
    ...
    [0x37f14c09742a481en, { id: 0x37f14c09742a481en, type_params: [], kind: { tag: 'struct', name: 'ProbeDiffThread', fields: [{ name: 'tid', type_ref: { tag: 'concrete', type_id: 0x281c5be4f2ee63b4n, args: [] }, required: true }, { name: 'kperf_samples', type_ref: { tag: 'concrete', type_id: 0xd9356298b81639acn, args: [] }, required: true }, { name: 'kperf_kernel_stack_samples', type_ref: { tag: 'concrete', type_id: 0xd9356298b81639acn, args: [] }, required: true }, { name: 'probe_results', type_ref: { tag: 'concrete', type_id: 0xd9356298b81639acn, args: [] }, required: true }, { name: 'paired', type_ref: { tag: 'concrete', type_id: 0xd9356298b81639acn, args: [] }, required: true }, { name: 'kperf_only', type_ref: { tag: 'concrete', type_id: 0xd9356298b81639acn, args: [] }, required: true }, { name: 'probe_only', type_ref: { tag: 'concrete', type_id: 0xd9356298b81639acn, args: [] }, required: true }, { name: 'pc_match', type_ref: { tag: 'concrete', type_id: 0xd9356298b81639acn, args: [] }, required: true }, { name: 'stitchable', type_ref: { tag: 'concrete', type_id: 0xd9356298b81639acn, args: [] }, required: true }, { name: 'richer_than_kperf', type_ref: { tag: 'concrete', type_id: 0xd9356298b81639acn, args: [] }, required: true }, { name: 'dwarf_richer_than_fp', type_ref: { tag: 'concrete', type_id: 0xd9356298b81639acn, args: [] }, required: true }, { name: 'compact_stitchable', type_ref: { tag: 'concrete', type_id: 0xd9356298b81639acn, args: [] }, required: true }, { name: 'compact_dwarf_stitchable', type_ref: { tag: 'concrete', type_id: 0xd9356298b81639acn, args: [] }, required: true }, { name: 'dwarf_stitchable', type_ref: { tag: 'concrete', type_id: 0xd9356298b81639acn, args: [] }, required: true }, { name: 'avg_common_suffix', type_ref: { tag: 'concrete', type_id: 0x8e02f623d1b2310cn, args: [] }, required: true }, { name: 'avg_compact_common_suffix', type_ref: { tag: 'concrete', type_id: 0x8e02f623d1b2310cn, args: [] }, required: true }, { name: 'avg_compact_dwarf_common_suffix', type_ref: { tag: 'concrete', type_id: 0x8e02f623d1b2310cn, args: [] }, required: true }, { name: 'avg_dwarf_common_suffix', type_ref: { tag: 'concrete', type_id: 0x8e02f623d1b2310cn, args: [] }, required: true }, { name: 'thread_name', type_ref: { tag: 'concrete', type_id: 0xdcafd4de6b7969bbn, args: [{ tag: 'concrete', type_id: 0x6d7dce914ee150e8n, args: [] }] }, required: true }] } }],
    ...
    [0x8599bb895806a3a2n, { id: 0x8599bb895806a3a2n, type_params: [], kind: { tag: 'struct', name: 'ProbeDiffEntry', fields: [{ name: 'tid', type_ref: { tag: 'concrete', type_id: 0x281c5be4f2ee63b4n, args: [] }, required: true }, { name: 'timestamp_ns', type_ref: { tag: 'concrete', type_id: 0xd9356298b81639acn, args: [] }, required: true }, { name: 'drift_ns', type_ref: { tag: 'concrete', type_id: 0xc6eb8c46f1e17fban, args: [] }, required: true }, { name: 'timing', type_ref: { tag: 'concrete', type_id: 0xa4898f014ca93f92n, args: [] }, required: true }, { name: 'queue', type_ref: { tag: 'concrete', type_id: 0x34ae3055219d9613n, args: [] }, required: true }, { name: 'kperf_stack', type_ref: { tag: 'concrete', type_id: 0x0a96b404b4d79d67n, args: [{ tag: 'concrete', type_id: 0xa24a048785643f31n, args: [] }] }, required: true }, { name: 'kperf_kernel_stack', type_ref: { tag: 'concrete', type_id: 0x0a96b404b4d79d67n, args: [{ tag: 'concrete', type_id: 0xa24a048785643f31n, args: [] }] }, required: true }, { name: 'probe_stack', type_ref: { tag: 'concrete', type_id: 0x0a96b404b4d79d67n, args: [{ tag: 'concrete', type_id: 0xa24a048785643f31n, args: [] }] }, required: true }, { name: 'compact_stack', type_ref: { tag: 'concrete', type_id: 0x0a96b404b4d79d67n, args: [{ tag: 'concrete', type_id: 0xa24a048785643f31n, args: [] }] }, required: true }, { name: 'compact_dwarf_stack', type_ref: { tag: 'concrete', type_id: 0x0a96b404b4d79d67n, args: [{ tag: 'concrete', type_id: 0xa24a048785643f31n, args: [] }] }, required: true }, { name: 'dwarf_stack', type_ref: { tag: 'concrete', type_id: 0x0a96b404b4d79d67n, args: [{ tag: 'concrete', type_id: 0xa24a048785643f31n, args: [] }] }, required: true }, { name: 'stitched_stack', type_ref: { tag: 'concrete', type_id: 0x0a96b404b4d79d67n, args: [{ tag: 'concrete', type_id: 0xa24a048785643f31n, args: [] }] }, required: true }, { name: 'common_suffix', type_ref: { tag: 'concrete', type_id: 0x281c5be4f2ee63b4n, args: [] }, required: true }, { name: 'compact_common_suffix', type_ref: { tag: 'concrete', type_id: 0x281c5be4f2ee63b4n, args: [] }, required: true }, { name: 'compact_dwarf_common_suffix', type_ref: { tag: 'concrete', type_id: 0x281c5be4f2ee63b4n, args: [] }, required: true }, { name: 'dwarf_common_suffix', type_ref: { tag: 'concrete', type_id: 0x281c5be4f2ee63b4n, args: [] }, required: true }, { name: 'pc_match', type_ref: { tag: 'concrete', type_id: 0x178367a87f66fb46n, args: [] }, required: true }, { name: 'stitchable', type_ref: { tag: 'concrete', type_id: 0x178367a87f66fb46n, args: [] }, required: true }, { name: 'used_framehop', type_ref: { tag: 'concrete', type_id: 0x178367a87f66fb46n, args: [] }, required: true }] } }],
    [0x42205a4141136a84n, { id: 0x42205a4141136a84n, type_params: [], kind: { tag: 'struct', name: 'ProbeDiffUpdate', fields: [{ name: 'total_kperf_samples', type_ref: { tag: 'concrete', type_id: 0xd9356298b81639acn, args: [] }, required: true }, { name: 'total_probes', type_ref: { tag: 'concrete', type_id: 0xd9356298b81639acn, args: [] }, required: true }, { name: 'kperf_kernel_stack_samples', type_ref: { tag: 'concrete', type_id: 0xd9356298b81639acn, args: [] }, required: true }, { name: 'kperf_kernel_frames', type_ref: { tag: 'concrete', type_id: 0xd9356298b81639acn, args: [] }, required: true }, { name: 'max_kperf_kernel_frames', type_ref: { tag: 'concrete', type_id: 0x281c5be4f2ee63b4n, args: [] }, required: true }, { name: 'paired', type_ref: { tag: 'concrete', type_id: 0xd9356298b81639acn, args: [] }, required: true }, { name: 'paired_kernel_stack_samples', type_ref: { tag: 'concrete', type_id: 0xd9356298b81639acn, args: [] }, required: true }, { name: 'kperf_only', type_ref: { tag: 'concrete', type_id: 0xd9356298b81639acn, args: [] }, required: true }, { name: 'probe_only', type_ref: { tag: 'concrete', type_id: 0xd9356298b81639acn, args: [] }, required: true }, { name: 'probe_augmented_kperf', type_ref: { tag: 'concrete', type_id: 0xd9356298b81639acn, args: [] }, required: true }, { name: 'probe_walked_deeper', type_ref: { tag: 'concrete', type_id: 0xd9356298b81639acn, args: [] }, required: true }, { name: 'common_suffix_hist', type_ref: { tag: 'concrete', type_id: 0x0a96b404b4d79d67n, args: [{ tag: 'concrete', type_id: 0xd9356298b81639acn, args: [] }] }, required: true }, { name: 'compact_suffix_hist', type_ref: { tag: 'concrete', type_id: 0x0a96b404b4d79d67n, args: [{ tag: 'concrete', type_id: 0xd9356298b81639acn, args: [] }] }, required: true }, { name: 'compact_dwarf_suffix_hist', type_ref: { tag: 'concrete', type_id: 0x0a96b404b4d79d67n, args: [{ tag: 'concrete', type_id: 0xd9356298b81639acn, args: [] }] }, required: true }, { name: 'dwarf_suffix_hist', type_ref: { tag: 'concrete', type_id: 0x0a96b404b4d79d67n, args: [{ tag: 'concrete', type_id: 0xd9356298b81639acn, args: [] }] }, required: true }, { name: 'depth_match', type_ref: { tag: 'concrete', type_id: 0x0a96b404b4d79d67n, args: [{ tag: 'concrete', type_id: 0x28630521853183b3n, args: [] }] }, required: true }, { name: 'drift_buckets', type_ref: { tag: 'concrete', type_id: 0x0a96b404b4d79d67n, args: [{ tag: 'concrete', type_id: 0x605b8a9435bfeb8en, args: [] }] }, required: true }, { name: 'timing', type_ref: { tag: 'concrete', type_id: 0x38b2065fc8bb23f8n, args: [] }, required: true }, { name: 'pc_match', type_ref: { tag: 'concrete', type_id: 0xd9356298b81639acn, args: [] }, required: true }, { name: 'stitchable', type_ref: { tag: 'concrete', type_id: 0xd9356298b81639acn, args: [] }, required: true }, { name: 'richer_than_kperf', type_ref: { tag: 'concrete', type_id: 0xd9356298b81639acn, args: [] }, required: true }, { name: 'dwarf_richer_than_fp', type_ref: { tag: 'concrete', type_id: 0xd9356298b81639acn, args: [] }, required: true }, { name: 'compact_stitchable', type_ref: { tag: 'concrete', type_id: 0xd9356298b81639acn, args: [] }, required: true }, { name: 'compact_dwarf_stitchable', type_ref: { tag: 'concrete', type_id: 0xd9356298b81639acn, args: [] }, required: true }, { name: 'dwarf_stitchable', type_ref: { tag: 'concrete', type_id: 0xd9356298b81639acn, args: [] }, required: true }, { name: 'framehop_used', type_ref: { tag: 'concrete', type_id: 0xd9356298b81639acn, args: [] }, required: true }, { name: 'compact_used', type_ref: { tag: 'concrete', type_id: 0xd9356298b81639acn, args: [] }, required: true }, { name: 'compact_dwarf_used', type_ref: { tag: 'concrete', type_id: 0xd9356298b81639acn, args: [] }, required: true }, { name: 'fp_walk_used', type_ref: { tag: 'concrete', type_id: 0xd9356298b81639acn, args: [] }, required: true }, { name: 'threads', type_ref: { tag: 'concrete', type_id: 0x0a96b404b4d79d67n, args: [{ tag: 'concrete', type_id: 0x37f14c09742a481en, args: [] }] }, required: true }, { name: 'richer', type_ref: { tag: 'concrete', type_id: 0x0a96b404b4d79d67n, args: [{ tag: 'concrete', type_id: 0x8599bb895806a3a2n, args: [] }] }, required: true }, { name: 'dwarf_richer', type_ref: { tag: 'concrete', type_id: 0x0a96b404b4d79d67n, args: [{ tag: 'concrete', type_id: 0x8599bb895806a3a2n, args: [] }] }, required: true }, { name: 'recent', type_ref: { tag: 'concrete', type_id: 0x0a96b404b4d79d67n, args: [{ tag: 'concrete', type_id: 0x8599bb895806a3a2n, args: [] }] }, required: true }] } }],
  ]),
  methods: new Map<bigint, import("@bearcove/vox-core").MethodSendSchemas>([
    ...
    [0xc853dfab2eb75d77n, { argsRootRef: { tag: 'concrete', type_id: 0x6847ab90feda71c1n, args: [{ tag: 'concrete', type_id: 0xdcafd4de6b7969bbn, args: [{ tag: 'concrete', type_id: 0x281c5be4f2ee63b4n, args: [] }] }] }, responseRootRef: { tag: 'concrete', type_id: 0x42046de663beeef0n, args: [{ tag: 'concrete', type_id: 0x42205a4141136a84n, args: [] }, { tag: 'concrete', type_id: 0x4cf4b2aeb98a1939n, args: [{ tag: 'concrete', type_id: 0x5db70a394660f3e6n, args: [] }] }] } }],
    [0x45bb91e63c98208an, { argsRootRef: { tag: 'concrete', type_id: 0xba0496aa8cee7a4cn, args: [{ tag: 'concrete', type_id: 0xdcafd4de6b7969bbn, args: [{ tag: 'concrete', type_id: 0x281c5be4f2ee63b4n, args: [] }] }, { tag: 'concrete', type_id: 0xc886545a493d06ebn, args: [{ tag: 'concrete', type_id: 0x42205a4141136a84n, args: [] }] }] }, responseRootRef: { tag: 'concrete', type_id: 0x42046de663beeef0n, args: [{ tag: 'concrete', type_id: 0xbc5c33249a2dc720n, args: [] }, { tag: 'concrete', type_id: 0x4cf4b2aeb98a1939n, args: [{ tag: 'concrete', type_id: 0x5db70a394660f3e6n, args: [] }] }] } }],
  ]),
};
