...
//! tear down on exit.
//!
//! The kperf/kdebug bring-up sequence mirrors `nerf-mac-kperf::recorder`
...
use nerf_mac_kperf_sys::bindings::{self, Frameworks};
use nerf_mac_kperf_sys::kdebug::{self, KdBuf, KdRegtype};
use nperfd_proto::{KdBufBatch, KdBufWire, RecordError, RecordSummary, SessionConfig};
...
fn map_kperf_err(e: nerf_mac_kperf_sys::Error) -> RecordError {
    use nerf_mac_kperf_sys::Error;
    match e {
