...
nonisolated(unsafe) public let profiler_schema_registry: [UInt64: Schema] = [
    ...
    0xb408aa07bc17494f: Schema(id: 0xb408aa07bc17494f, typeParams: [], kind: .struct(name: "ProbeDiffUpdate", fields: [FieldSchema(name: "total_kperf_samples", typeRef: .concrete(0xd9356298b81639ac), required: true), FieldSchema(name: "total_probes", typeRef: .concrete(0xd9356298b81639ac), required: true), FieldSchema(name: "paired", typeRef: .concrete(0xd9356298b81639ac), required: true), FieldSchema(name: "kperf_only", typeRef: .concrete(0xd9356298b81639ac), required: true), FieldSchema(name: "probe_only", typeRef: .concrete(0xd9356298b81639ac), required: true), FieldSchema(name: "probe_augmented_kperf", typeRef: .concrete(0xd9356298b81639ac), required: true), FieldSchema(name: "probe_walked_deeper", typeRef: .concrete(0xd9356298b81639ac), required: true), FieldSchema(name: "common_suffix_hist", typeRef: .generic(0x0a96b404b4d79d67, args: [.concrete(0xd9356298b81639ac)]), required: true), FieldSchema(name: "depth_match", typeRef: .generic(0x0a96b404b4d79d67, args: [.concrete(0x28630521853183b3)]), required: true), FieldSchema(name: "drift_buckets", typeRef: .generic(0x0a96b404b4d79d67, args: [.concrete(0x605b8a9435bfeb8e)]), required: true), FieldSchema(name: "timing", typeRef: .concrete(0x38b2065fc8bb23f8), required: true), FieldSchema(name: "pc_match", typeRef: .concrete(0xd9356298b81639ac), required: true), FieldSchema(name: "stitchable", typeRef: .concrete(0xd9356298b81639ac), required: true), FieldSchema(name: "framehop_used", typeRef: .concrete(0xd9356298b81639ac), required: true), FieldSchema(name: "fp_walk_used", typeRef: .concrete(0xd9356298b81639ac), required: true), FieldSchema(name: "threads", typeRef: .generic(0x0a96b404b4d79d67, args: [.concrete(0xbadbd285b0ba0b5b)]), required: true), FieldSchema(name: "recent", typeRef: .generic(0x0a96b404b4d79d67, args: [.concrete(0xbd4978fdffd45268)]), required: true)])),
    0xba0496aa8cee7a4c: Schema(id: 0xba0496aa8cee7a4c, typeParams: ["T0", "T1"], kind: .tuple(elements: [.var(name: "T0"), .var(name: "T1")])),
    0xbadbd285b0ba0b5b: Schema(id: 0xbadbd285b0ba0b5b, typeParams: [], kind: .struct(name: "ProbeDiffThread", fields: [FieldSchema(name: "tid", typeRef: .concrete(0x281c5be4f2ee63b4), required: true), FieldSchema(name: "kperf_samples", typeRef: .concrete(0xd9356298b81639ac), required: true), FieldSchema(name: "probe_results", typeRef: .concrete(0xd9356298b81639ac), required: true), FieldSchema(name: "paired", typeRef: .concrete(0xd9356298b81639ac), required: true), FieldSchema(name: "kperf_only", typeRef: .concrete(0xd9356298b81639ac), required: true), FieldSchema(name: "probe_only", typeRef: .concrete(0xd9356298b81639ac), required: true), FieldSchema(name: "pc_match", typeRef: .concrete(0xd9356298b81639ac), required: true), FieldSchema(name: "stitchable", typeRef: .concrete(0xd9356298b81639ac), required: true), FieldSchema(name: "avg_common_suffix", typeRef: .concrete(0x8e02f623d1b2310c), required: true), FieldSchema(name: "thread_name", typeRef: .generic(0xdcafd4de6b7969bb, args: [.concrete(0x6d7dce914ee150e8)]), required: true)])),
...
nonisolated(unsafe) public let profiler_method_schemas: [UInt64: MethodSchemaInfo] = [
    ...
    0xc853dfab2eb75d77: MethodSchemaInfo(
        argsSchemaIds: [0x281c5be4f2ee63b4, 0xdcafd4de6b7969bb, 0x6847ab90feda71c1],
        argsRoot: .generic(0x6847ab90feda71c1, args: [.generic(0xdcafd4de6b7969bb, args: [.concrete(0x281c5be4f2ee63b4)])]),
        responseSchemaIds: [0x178367a87f66fb46, 0x281c5be4f2ee63b4, 0x42046de663beeef0, 0x5db70a394660f3e6, 0x6d7dce914ee150e8, 0x4cf4b2aeb98a1939, 0xd9356298b81639ac, 0x0a96b404b4d79d67, 0x28630521853183b3, 0x605b8a9435bfeb8e, 0x38b2065fc8bb23f8, 0x8e02f623d1b2310c, 0xdcafd4de6b7969bb, 0xbadbd285b0ba0b5b, 0xc6eb8c46f1e17fba, 0xa4898f014ca93f92, 0x34ae3055219d9613, 0xa24a048785643f31, 0xbd4978fdffd45268, 0xb408aa07bc17494f],
        responseRoot: .generic(0x42046de663beeef0, args: [.concrete(0xb408aa07bc17494f), .generic(0x4cf4b2aeb98a1939, args: [.concrete(0x5db70a394660f3e6)])])
    ),
    0x45bb91e63c98208a: MethodSchemaInfo(
        argsSchemaIds: [0x281c5be4f2ee63b4, 0xdcafd4de6b7969bb, 0xd9356298b81639ac, 0x0a96b404b4d79d67, 0x28630521853183b3, 0x605b8a9435bfeb8e, 0x38b2065fc8bb23f8, 0x8e02f623d1b2310c, 0x6d7dce914ee150e8, 0xbadbd285b0ba0b5b, 0xc6eb8c46f1e17fba, 0xa4898f014ca93f92, 0x34ae3055219d9613, 0xa24a048785643f31, 0x178367a87f66fb46, 0xbd4978fdffd45268, 0xb408aa07bc17494f, 0xc886545a493d06eb, 0xba0496aa8cee7a4c],
        argsRoot: .generic(0xba0496aa8cee7a4c, args: [.generic(0xdcafd4de6b7969bb, args: [.concrete(0x281c5be4f2ee63b4)]), .generic(0xc886545a493d06eb, args: [.concrete(0xb408aa07bc17494f)])]),
        responseSchemaIds: [0x178367a87f66fb46, 0x281c5be4f2ee63b4, 0x42046de663beeef0, 0x5db70a394660f3e6, 0x6d7dce914ee150e8, 0x4cf4b2aeb98a1939, 0xbc5c33249a2dc720],
        responseRoot: .generic(0x42046de663beeef0, args: [.concrete(0xbc5c33249a2dc720), .generic(0x4cf4b2aeb98a1939, args: [.concrete(0x5db70a394660f3e6)])])
    ),
]
